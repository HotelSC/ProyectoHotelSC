...
// GET lista de todos los alumnes, vinculamos la ruta /api/alumnes a la función declarada.
// Si todo ok devolveremos un objeto tipo: {ok: true, data: [lista_de_objetos_alumne...]}
// si se produce un error: {ok: false, error: mensaje_de_error}
